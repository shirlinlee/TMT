$(function () {
  ...
  moreBtn.on('click', function () {
    ...
    if (!$(this).hasClass('open')) {
      ...
      $('.navList').find('.firstUl').addClass('hide')
      ...
      $('.navList').find('.firstUl').removeClass('hide')
  ...
  clickArr.on('click', function () {
    if (!$(this).hasClass('open')) {
      clickArr.removeClass('open')
      $(this).addClass('open')
      $('.trdNavList').slideUp(150)
      $('.secNavList>li').removeClass('sDown')
      $(this).parents('.secNavList>li').addClass('sDown')
      $(this).parents('.secNavList>li').find('.trdNavList').stop(true).slideDown(250)
    } else {
      $(this).removeClass('open')
      $(this).parents('.secNavList>li').removeClass('sDown')
      $(this).parents('.secNavList>li').find('.trdNavList').slideUp(150)
    }
  })

  //社群連結
  var winTop, socialMContainer = $('.hdTop');
  ...
  //小選單打開
  $('.firstUl').on('mouseenter', function () {
    if (!$(this).hasClass('downD')) {
      $(this).addClass('downD')
      $(this).find('.inList').stop(true).slideDown(200)
    }
  }).on('mouseleave', function () {
    $(this).removeClass('downD')
    $(this).find('.inList').slideUp(150)
  })
